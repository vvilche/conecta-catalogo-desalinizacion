...
CONFIG = {
    "titulo": "Catálogo de Desalinización — Chile",  # <title> + h1 del index
    "kicker_index": "Inteligencia comercial · Desalinización",
    "sub_index": ("Plantas desalinizadoras de Chile (instaladas y proyectadas) + las empresas "
                  "EPC/constructoras e ingenierías que las hacen. Cada ficha trae: quién es, qué hace, "
                  "proyectos, team de compras y el ángulo CONECTA — todo con fuente verificable."),
    "kicker_ficha": "Expediente de prospecto · Desalinización",
    "ficha_sufijo": "· Desalinización",  # sufijo del <title> de cada ficha
    "empresas_label": "Entidades",
    "footer_index": "CONECTA Ingeniería · Catálogo de desalinización · agosto 2026",
    "footer_ficha": "CONECTA Ingeniería · Catálogo de desalinización · agosto 2026 · Cada dato cita su fuente verificable",
    "leyenda": [  # (clase-dot, texto)
        ("c", "CANAL — EPC/constructora/ingeniería que subcontrata la especialidad eléctrica/control"),
        ("g", "CLIENTE FINAL — planta desaladora que compra DCS + SCADA + instrumentación"),
    ],
}
